...
public class MazeController {
    ...
    /**
     * Critical: Scene must be passed to controller AFTER Scene is created.
     */
    public void connectScene(Scene sc) {
        ...
        // Ensure clicks refocus on canvas
        scene.setOnMouseClicked(e -> requestCanvasFocus());

        // Canvas MUST get focus after stage is shown
        requestCanvasFocus();
    }

    /**
     * Ensures Canvas gets focus at the right time.
     */
